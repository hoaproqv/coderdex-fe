...
export default function PokeList() {
  const { pokemons, next, totalPages } = useSelector((state) => state.pokemons);
            ...
            >
              {pokemons.length &&
                pokemons.map((pokemon) => {
                  const typesPkm = [pokemon["type_1"], pokemon["type_2"]];
                  return (
                    <Grid
                      sx={{
                        display: "flex",
              ...
              <Grid sx={{ textAlign: "center" }} item xs={12} sm={12} md={12}>
                ...
                <Button
                  sx={{
                    ...styles.loadmore,
                    display: totalPages === 1 || next ? "none" : "inline-block",
                  }}
                  onClick={() => dispatch(setNext(true))}
                >
                  Load more Pokémon
                </Button>
              </Grid>
